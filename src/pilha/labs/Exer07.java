...
public class Exer07 {
	...
	public static String decimalBinario(int numero){
		...
		while (numero > 0){
			resto = numero % 2;// pegando o resto da divisao,como binario pegamos 2
			pilha.push(resto);
			numero /= 2; //numero = numero /2 , depois pegamos o numero / 2 até que  numero seja 0
		}

		while (!pilha.isEmpty()){// nao estiver vazia
			numBinario += pilha.pop();//desimpilha
		}
