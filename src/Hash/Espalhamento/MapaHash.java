...
- entrySet() - Retorna um conjunto de Maps contido no mapa configurado, podendo ser possível acessar 
    ...
    */
    public void put(Registro registro){
        ...
        if (valores[posicao] == null){
            ...
            /*
            Nesta parte precisamos utilizar o reg.getProximo, para que continue o andamente da lista
            e verificando cada caso.
            */
    ...
    /*
    Ou seja onde passamos uma chave
    */
